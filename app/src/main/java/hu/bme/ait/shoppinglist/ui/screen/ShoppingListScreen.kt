...
fun ShoppingListScreen(
    ...
    var shoppingList = shoppingViewModel.getAllItems().collectAsState(emptyList())

    var context = LocalContext.current
    val add = MediaPlayer.create(context, R.raw.add)
    val cards = MediaPlayer.create(context, R.raw.cards)
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        context.getString(R.string.your_flash_cart),
        ...
        if (showCautionDialog) {
            CautionDialog(shoppingViewModel, onCancel = { showCautionDialog = false })
        }
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                userInput = it
                                try {
                                    userInput.toFloat(); inputPriceErrorState = false; price =
                                        it.toFloat()
                                } catch (e: Exception) {
                        ...
                        SpinnerSample(
                            listOf(context.getString(R.string.food), context.getString(R.string.clothes),context.getString(R.string.stationaries), context.getString(R.string.toiletries), context.getString(R.string.misc)),
